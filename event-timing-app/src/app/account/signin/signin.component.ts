...
export class SigninComponent implements OnInit {
  ...
  signIn(){
    ...
    this.inProgress = true;
      this._authService.signIn(this.login.value, this.password.value)
      .pipe(finalize(() => {
      ...
      .subscribe(isSuccessful => {
        ...
        if ( isSuccessful){                  
          ...
          this._errorProcessingService.showBusinessError('Ошибка при входе', 'Неверный логин или пароль!');     
        }
      }, error => {
